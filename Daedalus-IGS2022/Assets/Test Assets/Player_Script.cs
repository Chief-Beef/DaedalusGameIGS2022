...
public class Player_Script : MonoBehaviour
{
    ...
    private RaycastHit2D grappleRay;
    private bool isGrappling = false;
    private bool canFire = true;
    private bool canReload = false;
    public GameObject staminaBar;

    public float grappleStamina;
        ...
        */
        ...
        if (Input.GetAxis("Fire2") > 0 && canFire && currentStamina > 0)
        {
            if (canGrapple)
            {
                ...
                grappleRay = Physics2D.Raycast(this.transform.position, mousePos - this.transform.position, grappleRange, ground);
